...
// получаем все позиции Middle
const p1HtmlM = document.querySelector("#p1M");
const p2HtmlM = document.querySelector("#p2M");
const p3HtmlM = document.querySelector("#p3M");
const p4HtmlM = document.querySelector("#p4M");
const p5HtmlM = document.querySelector("#p5M");
const p6HtmlM = document.querySelector("#p6M");
const p7HtmlM = document.querySelector("#p7M");
const p8HtmlM = document.querySelector("#p8M");
const p12HtmlM = document.querySelector("#p12M");
const p13HtmlM = document.querySelector("#p13M");
const p14HtmlM = document.querySelector("#p14M");

//All ответы сложения LEFT + Right + Middle
